...
from flow.dataset import TFDSImagenet64, KaggleImageFolderImagenet64, TFDSImagenet32, KaggleImageFolderImagenet, TorchvisionCIFAR10, ImageNet21kFolder
from tqdm import tqdm
import wandb
import pathlib
import argparse
from flow.accelerator_gpu import GPUAccelerator
try:
    from flow.accelerator_tpu import TPUAccelerator
    _HAS_TPU = True
except Exception:
    TPUAccelerator = None
    _HAS_TPU = False
...
def main():
    ...
    parser.add_argument("--N", "--model_depth", dest="N", type=int, default=12, help="Number of coupling layers (N)")
    parser.add_argument("--vit_depth", "--model_block_depth", dest="vit_depth", type=int, default=2, help="ViT depth (blocks per coupling)")
    parser.add_argument("--vit_dim", "--model_emb_dim", dest="vit_dim", type=int, default=192, help="ViT hidden dimension (width)")
    parser.add_argument("--vit_heads", "--model_num_heads", dest="vit_heads", type=int, default=3, help="ViT attention heads")
    ...
    parser.add_argument("--M", "--model_channel_repeat", dest="M", type=int, default=4, help="Ratio M: number of channel couplings before 1 spatial")
